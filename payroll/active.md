# 01_工资模块（v2026-01-05R73）
版本 v2026-01-05R73
生效：2026-01-05
打印版本 v2026-01-05R73

## 变更说明（R73）
- 选表规则补齐“交叉命中”差值判定：当存在 2 个 CSV 时，按差值分数选出勤/报销表，且两者差值均 > 0 且文件不同才放行；否则 Hard 阻断并打印候选得分。
- 选表审计输出增加：出勤/报销命中与差值分数。
...
- 版本尾注固定：计算口径版本 v2026-01-05R73｜阻断模式：Hard。
## 批量出单（项目结算）
