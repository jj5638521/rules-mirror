...
## 变更说明（R61）
- 新增项目结算批量出单入口与汇总索引。
- 角色来源与日薪来源优先级锁定，口令支持角色/固定日薪块。
- 批量出单要求项目已结束=是，否则 Hard 阻断并记录原因。
