# 01_工资模块（v2025-11-25R70）
版本 v2025-11-25R70
生效：2025-11-25
打印版本 v2025-11-25R70

## 变更说明（R70）
- PaymentPipe 收紧计入口径：仅当类型/科目/类别字段包含“工资”才计入已付/预支。
- 类型字段对支付候选行强制必填，缺失即 Hard 阻断并给出行号与证据。
- 备注关键词不再触发工资/预支计入，仅用于展示与日志。
...
- 版本尾注固定：计算口径版本 v2025-11-25R70｜阻断模式：Hard。
## 批量出单（项目结算）
