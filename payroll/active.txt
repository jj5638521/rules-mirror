# 01_工资模块（v2025-11-25R58）
版本 v2025-11-25R58
生效：2025-11-25
打印版本 v2025-11-25R58

## 变更说明（R58）
- 默认 verbose=0：终端正文不打印清洗日志/完整审计明细，仅保留 run_id + 规则版本并追加日志路径。
...
- 默认 verbose=0：正文仅输出 run_id + 规则版本；其他审计明细写入 logs/{run_id}.json。
